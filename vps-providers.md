...
In addition, we don't include a VPS provider here, if the price is higher than well known providers such as Hetzner, Ovh, DigitalOcean, AWS, Azure.
...
| Oracle              |  1           | 1    | 1    | 100 SSD      | Multi | 10            |[Order](https://www.oracle.com/cloud/free/#always-free)          50 Mbps link (up to 300Mbps). You can create 4 VM for Free (2 x64 + 2 ARM64 or 1 x64 + 3 ARM64 or 4 ARM64)). Credit Card or Paypal Required but you need to enter a real information to be able to use it. Don't try multiple time. One time with correct and accurate information select the location in your country and turn off proxy during sign up.     Update: seems that Oracle blocks IPs from Iran. So, you need to add them behind a CDN |
| euserv.com          |  1           | 1    | IPv6 | 10  HDD      | ?        | 1             |[Order](https://www.euserv.com/en/virtual-private-server/root-vserver/v2/vs2-free.php)          IPv6 Only. 2.35€ setup fee. You need to add them behind a CDN for Iran|
| Amazon AWS EC2          |  1       | 2    | 1    |  8 SSD           | Multi | 0.1           |[Order](https://aws.amazon.com/free) 1 yr; Needs Credit Card. |
| Amazon AWS Lightsail          |  2       | 2    | 1    |  60 SSD           | Multi | 3           |[Order](https://aws.amazon.com/free) 3 months; Needs Credit Card. |
| DigitalOcean Student|  1      | 1    | 1    | 25           | Multi | 1             | [Order](https://www.digitalocean.com/github-students/) 1 yr; Credit Card or Paypal Required, Free for Students Only,
...
| ikoula         |0.5|0.5|1|10 SSD| ? | ∞||            |[Order](https://www.ikoula.com/en/public-cloud) 16 month of free with €50 credit without duration|
...
|---------------------|--------|----------|------|----|--------------|----------|---------------|----------------|-----------------------------------------------------------------|-------------|
| EthernetServers | $12/yr | 1        | 1    | 2  | 30 SSD       | USA      | 2             | OpenVZ         | [Order](https://www.ethernetservers.com/clients/link.php?id=40) |
| RackNerd      | $11/yr | 0.75     | 1    | 1  | 12 SSD       | USA      | 1             | KVM            | [Order](https://my.racknerd.com/cart.php?a=add&pid=587)         |
...
| ApeWeb ([not verified)(https://www.trustpilot.com/review/apeweb.uk))| £12/yr | 0.5 | 2 | 1 | 10 SSD | Norway | ∞ | KVM | [Order](https://cms.apeweb.uk/index.php?rp=/store/iran-offer) | Yes |
...
| ApeWeb ([not verified)(https://www.trustpilot.com/review/apeweb.uk))| £18/yr | 1 | 2 | 1 | 20 SSD | Norway | ∞ | KVM | [Order](https://cms.apeweb.uk/index.php?rp=/store/iran-offer) | Yes |
